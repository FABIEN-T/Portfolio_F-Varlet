...
export default function SectionPortrait() {
  return (
    <div className="relative flex flex-col items-center px-6 text-center text-main pt-32">
      {/* Portrait */}
      ...
      <h1 className="text-4xl max-w-xs mx-auto font-light sm:text-5xl sm:max-w-lg md:text-6xl md:max-w-3xl">
        Développeur <span className="italic">Frontend</span>
      </h1>
      <h1 className="text-4xl mb-12 max-w-xs mx-auto font-light sm:text-5xl sm:mb-14 sm:max-w-md md:text-6xl md:max-w-xl">
        en quête de projets<span className="text-rose-600">.</span>
      </h1>
